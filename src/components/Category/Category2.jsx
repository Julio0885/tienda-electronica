              ...
              <div className='container'>
                <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8'>
                    ...
                    h-[320px] flex items-end '>
                        ...
                        <img className="w-[350px] absolute top-1/2 -translate-y-1/2 -right-0" src={Image1} alt="" />
                    </div>
                    {/* second col */}
                    ...
                    h-[320px] flex items-end'>
                        ...
                        <img className="w-[320px] absolute bottom-0" src={Image2} alt="" />
                    </div>
                    {/* third col */}
                    ...
                    h-[320px] flex items-end '>
                        <div>
                           <div className='bg-gradient-to-br from-amber-500 to-amber-300 text-white'>
                            <p className='mb-[2px] text-gray-400'>Enjoy</p>
                            <p className='text-2xl font-semibold mb-[2px]'>With</p>Buy                       <p className='text-4xl xl:text-5xl font-bold opacity-20 mb-2'>Speaker</p>
                            <Button
                            text="Buy"
                        ...
                        <img className="w-[320px] absolute -right-8 lg:top-[40px]" src={Image3} alt="" />
                    </div>
                </div>
              </div>
            </div>
